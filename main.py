...
imagens_andando_direita = [pygame.image.load(os.path.join(caminho_imagens, 'running_4.png')),
                           pygame.image.load(os.path.join(caminho_imagens, 'running_5.png')),
                           pygame.image.load(os.path.join(caminho_imagens, 'running_6.png')),
                           pygame.image.load(os.path.join(caminho_imagens, 'running_7.png')),
                           pygame.image.load(os.path.join(caminho_imagens, 'running_8.png'))]

imagens_andando_esquerda = [pygame.transform.flip(img, True, False) for img in imagens_andando_direita]

imagens_pulo = [pygame.image.load(os.path.join(caminho_imagens, 'jump_0.png')),
                pygame.image.load(os.path.join(caminho_imagens, 'jump_1.png'))]

imagens_pulo_direita = [pygame.transform.flip(img, True, False) for img in imagens_pulo]

# Imagens de corrida
imagens_correndo_direita = [pygame.image.load(os.path.join(caminho_imagens, 'running_fast_1.png')),
                            pygame.image.load(os.path.join(caminho_imagens, 'running_fast_2.png')),
                            pygame.image.load(os.path.join(caminho_imagens, 'running_fast_3.png')),
                            pygame.image.load(os.path.join(caminho_imagens, 'running_fast_4.png')),
                            pygame.image.load(os.path.join(caminho_imagens, 'running_fast_5.png'))]

imagens_correndo_esquerda = [pygame.transform.flip(img, True, False) for img in imagens_correndo_direita]
